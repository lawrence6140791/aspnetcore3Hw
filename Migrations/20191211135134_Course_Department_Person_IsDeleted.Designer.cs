...
namespace aspcore3hw.Migrations
{
    ...
    [Migration("20191211135134_Course_Department_Person_IsDeleted")]
    partial class Course_Department_Person_IsDeleted
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aspcore3hw.models.Course", b =>
                {
            ...
            modelBuilder.Entity("aspcore3hw.models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("aspcore3hw.models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("DepartmentID")
            ...
            modelBuilder.Entity("aspcore3hw.models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("aspcore3hw.models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("aspcore3hw.models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("aspcore3hw.models.Course", b =>
                {
                    b.HasOne("aspcore3hw.models.Department", "Department")
                        .WithMany("Course")
            ...
            modelBuilder.Entity("aspcore3hw.models.CourseInstructor", b =>
                {
                    b.HasOne("aspcore3hw.models.Course", "Course")
                    ...
                    b.HasOne("aspcore3hw.models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("aspcore3hw.models.Enrollment", b =>
                {
                    ...
                    b.HasOne("aspcore3hw.models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("aspcore3hw.models.OfficeAssignment", b =>
                {
                    b.HasOne("aspcore3hw.models.Person", "Instructor")
                        ...
                        .HasForeignKey("aspcore3hw.models.OfficeAssignment", "InstructorId")
